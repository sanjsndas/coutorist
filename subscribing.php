...
<html>
    <head>
        ...
        <title>Coutoristpar : Thanks for subscribing!</title>
        <meta property="og:title" content="Coutoristpar : Thanks for subscribing!" />
        <meta property="og:image" content="icon.png"/>
        
        <meta property="og:description" content="Coutoristpar : Thanks for subscribing!">
        <meta name="description" content="Coutoristpar : Thanks for subscribing!">
        <meta name="twitter:title" content="Coutoristpar : Thanks for subscribing!">
...
<style>
	* {
	...
	.bodyClass1-inventoryst__column{
		background: #fff8ff;
		color: #ffffff;
	}
	.bodyClass2-inventoryst__column{
		background: #fff;
		color: #fff;
	}
	.bodyClass3-inventoryst__column{
		background: #fff;
		color: #111;
	}
	.wrapage-block-inventoryst__column{
		background-size: 100%;
		width: 100%;
	}
	.box_main-inventoryst__column{
		width: 100%;
		margin: 0 auto;
		text-align: center;
		display: flex;
	...
	.box_main-inventoryst__column h2{
		font-size: 24px;
		padding: 0px 0px 25px;
	}
	.box_main-inventoryst__column p{
		font-weight: 500;
		font-size: 18px;
	}
	p{
	...
	.mainBlock-inventoryst__column{
		text-align: center;
	}
	.mainBlock-inventoryst__column ul{
		text-align: start;
		padding: 20px;
		display: flex;
		flex-direction: column;
	...
	.mainBlock-inventoryst__column ul>li span{
		font-weight: bold;
	}
	.mainBlock-inventoryst__column{
		max-width: 790px;
	...
	.mainBlock-inventoryst__column .cBlock-inventoryst__column{
		text-align: center;
	}

	.bodyClass3-inventoryst__column .mainBlock-inventoryst__column{
		background: none;
		border-top: 2px dashed #feffde;
		border-bottom: 2px dashed #feffde;
	}
	.bodyClass2-inventoryst__column .mainBlock-inventoryst__column{
		background: #272121;
		color: #fff !important;
		box-shadow: 0px 0px 20px #272121;
	}
	.bodyClass2-inventoryst__column .mainBlock-inventoryst__column p{
		color: #fff !important;
	}
	.bodyClass1-inventoryst__column .mainBlock-inventoryst__column{
		background: #00469E;
		color: #ffffff;
		border-left: 4px solid #222831;
	}
	.bodyClass1-inventoryst__column .mainBlock-inventoryst__column p{
		color: #ffffff !important;
	}
	.order-inventoryst__column{
...
<div class="bodyClass2-inventoryst__column" id="mainWrapp-inventoryst__column">


	<div class="wrapage-block-inventoryst__column">
		<div class="box_main-inventoryst__column">
			<div class="mainBlock-inventoryst__column">
				<h2>We sincerely thank you for your interest and subscription on our website! We are delighted to have you among our subscribers.</h2>
<p>Now you will be among the first to learn about our new arrivals, promotions, exclusive offers, and the latest news. We promise to send only the most relevant and interesting information!</p>
<p>A few things to enhance your experience:</p>
<ul>
    <li><span>Personalization:</span> If you have specific interests or preferences, please specify them in your profile settings so that we can send you the most relevant offers and news.</li>
    <li><span>No spam:</span> We respect your time and mailbox. Therefore, we promise not to overwhelm you with unnecessary information.</li>
    <li><span>Your feedback matters:</span> If you have any wishes, feedback, or suggestions, feel free to share them with us. Your opinion helps us to improve!</li>
</ul>
<p>If you accidentally subscribed or decide to unsubscribe in the future, you can always do so by following the corresponding link in any email from us.</p>
			</div>
		</div>
	</div>
